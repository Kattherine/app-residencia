...
function cliente($myusername, $mypassword, $conn){
	$sql = "SELECT id FROM personal WHERE usuario = '$myusername' AND contrasena = '$mypassword'";
...
function resultado($myusername, $mypassword, $conn){
	$sql_clave = "SELECT id, contrasena FROM personal WHERE usuario = '$myusername'";
...
function idUsuario($myusername, $mypassword, $conn){
	$sql_clave = "SELECT id, contrasena FROM personal WHERE usuario = '$myusername'";
	$rs_clave = mysqli_query($conn,$sql_clave);
	$result_clave = mysqli_fetch_assoc($rs_clave);
